            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                        <a href="/crm_app07/role-add" class="btn btn-sm btn-success">Thêm mới</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /row -->
                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <a href="/crm_app07/role-update?id=${roles.id}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="/crm_app07/roles?id=${roles.id}" class="btn btn-sm btn-danger">Xóa</a>
                                            </td>
                                        </tr>  
                                        </c:forEach>
                                    </tbody>
